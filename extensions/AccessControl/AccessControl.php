...
// Remark: position to add code to use namespace from mediawiki
	...
	if ( method_exists( 'WikiPage', 'getContent' ) ) {
		...
		//참고 https://www.mediawiki.org/wiki/Extension_talk:AccessControl/Archive_1#Undefined_variable:_rights_/_Fatal_error:_Call_to_a_member_function_getNativeData()
